          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-base font-medium">{t('components.signature.digest_algorithm')}</Label>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <Label className="text-base font-medium">{t('components.signature.signature_algorithm')}</Label>
              </div>
          ...
          {(signatureAlgorithm === 'hmac' || signatureAlgorithm === 'rsa' || signatureAlgorithm === 'sm2') && (
            <div className="border rounded-lg p-4 bg-muted/30 space-y-4">
              ...
              {(signatureAlgorithm === 'rsa' || signatureAlgorithm === 'sm2') && (
                <div className="space-y-2">
                  <Label htmlFor="signatureConfig">{t('components.signature.signature_config')}</Label>
                  <Select 
